...
public class Reach_Asteroid {	
	...
	/**
	 * on consid��re que l'orbite de la Terre et de l'asteroide sont les m��mes
	 * @param dephasage (rad)
	 * @param duree (jours)
	 * @param poussee (N)
	 * @param masse (kg)
	...
	public ArrayList<Double> rdv(double dephasage, double duree, double poussee, double masse) {
		...
		// regarder la p��riodicit�� et les mouvements moyens pour savoir quand lancer
		...
		while (Math.abs(ac_calc)>acc) {
			t1=t1-1;
			if (t1<0) {
				System.out.println("Duree trop courte ou d��phasage trop grand");
	 ...
	 * @param poussee (N)
	 * @param masse (kg)
	 * @return (deltaV (m/s), deltaM (kg), duree(jours), 1 ou 0 en fonction de la possibilit�� low thrust)
	 */
	 ...
	 * @param poussee (N)
	 * @param masse (kg)
	 * @return (deltaV (m/s), deltaM (kg), duree(jours), 1 ou 0 low thrust, angle dephasage n��c��ssaire )
	 */
